...
-->
<h3>
    Edit: please use version on branch `typical-pr`! If you use this version, *do not* set a max length as it leads to undefined behavior.
</h3>
<h3>
    Typical Sampling
</h3>
...
```python
model.generate( input_ids, do_sample=True, typical_p=0.2)
```
